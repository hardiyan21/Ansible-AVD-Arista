...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.26.134/24 | 192.168.26.1 |
...
| --------- | --------------- | ------------ | --------- |
| HK_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_HK-LEAF1A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_HK-LEAF1A_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_HK-SPINE1_Ethernet2 | routed | - | 172.31.255.5/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_HK-SPINE2_Ethernet2 | routed | - | 172.31.255.7/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_HK-SPINE1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_HK-SPINE2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_HK-LEAF1A_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_HK-LEAF1A_Ethernet4
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_HK-LEAF1A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_HK-LEAF1A_Po3
   no shutdown
   switchport
...
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_APP_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WEB_Zone |
...
router bgp 65101
   ...
   neighbor 10.255.251.0 description HK-LEAF1A
   neighbor 172.31.255.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.4 description HK-SPINE1_Ethernet2
   neighbor 172.31.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.6 description HK-SPINE2_Ethernet2
