...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.26.136/24 | 192.168.26.1 |
...
| --------- | --------------- | ------------ | --------- |
| HK_LEAF2 | Vlan4094 | 10.255.252.4 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_HK-LEAF2A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_HK-LEAF2A_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_HK-SPINE1_Ethernet4 | routed | - | 172.31.255.13/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_HK-SPINE2_Ethernet4 | routed | - | 172.31.255.15/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_HK-SPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_HK-SPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_HK-LEAF2A_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_HK-LEAF2A_Ethernet4
   no shutdown
   channel-group 3 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_HK-LEAF2A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_HK-LEAF2A_Po3
   no shutdown
   switchport
...
| Vlan210 |  Tenant_B_OP_Zone  |  -  |  10.2.10.254/24  |  -  |  -  |  -  |  -  |
...
interface Vlan141
   ...
   no shutdown
   vrf Tenant_A_DB_Zone
   ip address virtual 10.1.41.254/24
!
interface Vlan210
...
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_APP_Zone |
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_DB_Zone |
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_OP_Zone |
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WEB_Zone |
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_OP_Zone |
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_OP_Zone |
...
router bgp 65102
   ...
   neighbor 10.255.251.4 description HK-LEAF2A
   neighbor 172.31.255.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.12 description HK-SPINE1_Ethernet4
   neighbor 172.31.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.14 description HK-SPINE2_Ethernet4
