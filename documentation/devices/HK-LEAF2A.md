...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.26.135/24 | 192.168.26.1 |
...
| --------- | --------------- | ------------ | --------- |
| HK_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_HK-LEAF2B_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_HK-LEAF2B_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet10 | server01_Eth2 | *trunk | *210-211 | *- | *- | 10 |
| Ethernet11 | server02_Eth2 | *trunk | *210-211 | *- | *- | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_HK-SPINE1_Ethernet3 | routed | - | 172.31.255.9/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_HK-SPINE2_Ethernet3 | routed | - | 172.31.255.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_HK-SPINE1_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_HK-SPINE2_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_HK-LEAF2B_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_HK-LEAF2B_Ethernet4
   no shutdown
   channel-group 3 mode active
!
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_HK-LEAF2B_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_HK-LEAF2B_Po3
   no shutdown
   switchport
...
| Tenant_A_OP_Zone | 192.168.255.5:10 | 10:10 | - | - | learned | 110-111 |
| Tenant_A_VMOTION | 192.168.255.5:50160 | 50160:50160 | - | - | learned | 160 |
...
router bgp 65102
   ...
   neighbor 10.255.251.5 description HK-LEAF2B
   neighbor 172.31.255.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.8 description HK-SPINE1_Ethernet3
   neighbor 172.31.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.10 description HK-SPINE2_Ethernet3
